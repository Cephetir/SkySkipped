...
public class RichPresence {
    ...
    public JsonObject toJson() {
        ...
        obj2.addProperty("start", startTimestamp == null ? null : startTimestamp.toEpochSecond());
        obj2.addProperty("end", endTimestamp == null ? null : endTimestamp.toEpochSecond());
        obj.add("timestamps", obj2);
        JsonObject obj3 = new JsonObject();
        obj3.addProperty("large_image", largeImageKey);
        obj3.addProperty("large_text", largeImageText);
        obj3.addProperty("small_image", smallImageKey);
        obj3.addProperty("small_text", smallImageText);
        obj.add("assets", obj3);
        if (partyId == null) obj.add("party", null);
        else {
            JsonObject obj4 = new JsonObject();
            obj4.addProperty("id", partyId);
            JsonArray arr = new JsonArray();
            arr.add(new JsonPrimitive(partySize));
            arr.add(new JsonPrimitive(partyMax));
            obj4.add("size", arr);
            obj.add("party", obj4);
        }
        JsonObject obj4 = new JsonObject();
        obj4.addProperty("join", joinSecret);
        obj4.addProperty("spectate", spectateSecret);
        obj4.addProperty("match", matchSecret);
        obj.add("secrets", obj4);
