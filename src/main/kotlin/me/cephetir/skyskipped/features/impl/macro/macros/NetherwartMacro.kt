...
class NetherwartMacro : Macro("NetherwartMacro") {
            ...
            FarmingState.CLIMB -> {
                ...
                if (ladderBlock.block != Blocks.ladder) {
                    ...
                    farmDirection = when (farmDirection) {
                        ...
                        FarmDirection.EAST -> FarmDirection.SOUTH
                    }
                    farmingState = FarmingState.SETUP
                    rotating = null
                }
            ...
            FarmingState.CLEAR_INV -> {
                ...
                when (clearInvSteps) {
                    ClearInvSteps.SETUP -> {
                        ...
                        sendWebhook("Full Inventory failsafe", "Inventory is full! Cleanning...", false)
    ...
    private fun onTickPost() {
        ...
        if (mc.currentScreen != null && mc.currentScreen !is GuiChat) return unpressKeys()
    ...
    private fun banwaveChecker(): Boolean {
        if (!Config.netherWartBanWaveChecker) return false
        if (checkerTicks++ < Config.netherWartBanWaveCheckerTimer * 60 * 20) return false
